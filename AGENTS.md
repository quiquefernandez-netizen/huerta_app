...
- Cada ingreso se registra como una aportación independiente con fecha e importe. La interfaz distingue la parte destinada a la cuota y la aportación adicional, pero conserva y destaca siempre el total aportado. El saldo familiar compensa aportaciones y gastos adelantados menos cuotas acumuladas, agua liquidada y derramas: positivo significa saldo a favor y negativo, pendiente de aportar.
