...
function renderBank() {
  ...
  return `${summary}${history}<aside class="info-note">${icon("bank")}<p><strong>Banco trabaja siempre con previsualización.</strong> La importación definitiva se habilita tras la revisión de administración.</p></aside>`;
}
